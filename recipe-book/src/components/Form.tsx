...
const units = ['g', 'kg', 'ml', 'l', 'oz', 'lb', 'pinch', 'tsp', 'tbsp', 'cup', 'pint', 'quart', 'gallon', 'ounce', 'pound', 'pinch', 'teaspoon', 'tablespoon', 'cup', 'pint', 'quart', 'gallon'];
...
export function RecipeForm() {
  ...
  const addIngredient = () => {
    setFormData(prev => ({
      ...prev,
      ingredients: [...prev.ingredients, { name: '', quantity: 0, unit: '', optional: false }]
    }));
  };
        ...
        <div className="form-group">
          ...
          >
           <option value="">Select Cost Range</option>
            ...
            <option key={index} value={costRange}>{costRange}</option>
            ))}
          </select>
        </div>
      </section>
      ...
      <section className="instructions">
        ...
        {formData.instructions.map((instruction, index) => (
          <div key={index} className="instruction-step">
            ...
            />
            <button disabled={true} type="button">+ Add Image</button>
          </div>
        ))}
